...
/**
 * Instructor layout — authenticated pages for Instructor role.
 * Similar to dashboard layout but with instructor-specific navigation.
 */
  ...
  <div class="instructor-layout">
    ...
    <aside class="sidebar" :class="{ open: sidebarOpen }">
      <div class="sidebar-header">
        <NuxtLink to="/instructor/dashboard" class="sidebar-logo" @click="closeSidebar">
          <span class="logo-icon">📚</span>
          <span class="logo-text">LMS — Instruktur</span>
        </NuxtLink>
      </div>
      ...
      <div class="sidebar-footer">
        <div class="user-info">
          ...
          <div class="user-details">
            <span class="user-name">{{ auth.user?.nama || 'Instruktur' }}</span>
